...
async function AvailableInterviewsPage() {
  ...
  const allInterviews = await getLatestInterviews({ userId: user?.id! });
      ...
      <div className="interviews-section">
        {hasInterviews ? (
          ...
          <div className="col-span-full flex flex-col items-center justify-center py-12 px-6 bg-dark-200/50 rounded-xl border border-light-800/10">
            ...
            <p className="text-light-400 text-center">There are no interviews available</p>
...
export default AvailableInterviewsPage;
